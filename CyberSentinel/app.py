...
app = Flask(__name__)
app.secret_key = 'cyber_sentinel_secret_key'  # Cambia esto en producción
...
def analyze():
    ...
    if file and allowed_file(file.filename):
        ...
        try:
            ...
            return render_template('result.html', analysis=analysis_data, report_filename=report_filename)
